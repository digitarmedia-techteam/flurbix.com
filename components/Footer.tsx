...
const footerLinks: Record<string, { label: string; href: string }[]> = {
  Product: [
    { label: "Dashboard", href: "https://app.flurbix.com" },
    { label: "Integrations", href: "https://app.flurbix.com/integrations" },
  ],
  Company: [
...
const socialLinks = [
  {
    href: "https://twitter.com/flurbix",
    label: "Follow Flurbix on X (Twitter)",
    Icon: TwitterIcon,
  },
  {
    href: "https://linkedin.com/company/flurbix",
    label: "Follow Flurbix on LinkedIn",
    Icon: LinkedInIcon,
  },
  {
    href: "https://github.com/flurbix",
    label: "View Flurbix on GitHub",
    Icon: GitHubIcon,
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="font-dm text-sm text-slate-600 dark:text-subtle mt-3 leading-relaxed max-w-[180px] transition-colors duration-300">
              The operating system for growth teams. Automate workflows, scale
              smarter.
            </p>
            <div
          ...
          {Object.entries(footerLinks).map(([heading, links]) => (
            <div key={heading}>
              <h4 className="font-syne font-semibold text-sm text-slate-900 dark:text-white mb-4 transition-colors duration-300">
                {heading}
              </h4>
